...
function EditPlayer(props){
    ...
    return(
        <tr>
                ...
                <td><input className="form-control" name="value" type="number" value={props.player.value} onChange={handleChange}/></td>
                <td>
                ...
                <td><input className="form-control" name="total" type="number" value={props.player.total} onChange={handleChange}/></td>
                <td><input className="form-control" name="assists" type="number" value={props.player.assists} onChange={handleChange}/></td>
                <td><input className="form-control" name="yellow" type="number" value={props.player.yellow} onChange={handleChange}/></td>
                <td><input className="form-control" name="red" type="number" value={props.player.red} onChange={handleChange}/></td>
                <td>
