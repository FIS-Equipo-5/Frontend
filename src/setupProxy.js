...
const API_TRANSFERS_URL = (process.env.TRANSFERS_URL || 'http://localhost:3001');
...
module.exports = function(app) {
  ...
  app.use(proxy('/api/v1/team', {target: API_TEAMS_PLAYER_URL}));
  app.use(proxy('/api/v1/player', {target: API_TEAMS_PLAYER_URL}));
};